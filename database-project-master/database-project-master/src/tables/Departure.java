...
public class Departure implements Table {
    ...
    public Departure(int passengerTrainID, int cargoTrainID, Timestamp arrivalTime, String locationID, String isDelayed) {
